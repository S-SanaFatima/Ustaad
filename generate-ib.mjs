...
const content = `import { useState, type ReactNode } from 'react';
...
fs.writeFileSync('src/app/IBTutorAbuDhabiPage.tsx', content, 'utf8');
console.log('Done creating IBTutorAbuDhabiPage.tsx!');
