...
const BLOG = {
  ...
  heroAlt: 'Secondary student studying mathematics and physics graphs in a bright study setting in the UAE',
  heroCaption: 'Calculating a gradient is only half the question, understanding what the number represents in physical reality is what earns top exam marks.',
