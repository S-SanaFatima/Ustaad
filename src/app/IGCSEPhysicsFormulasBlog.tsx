    ...
    <Layout>
      ...
      <div className="bg-[#f8fafd] border-b border-slate-100">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center gap-1.5 text-xs text-gray-400">
          ...
          <ChevronRightIcon className="h-3 w-3" />
          <span className="text-[#0f4a9b] font-semibold truncate max-w-[150px]">IGCSE Physics Formulas</span>
        </div>
      </div>
            ...
            <div className="mb-4 mt-2 space-y-2">
              <div className="flex items-start gap-2 text-xs text-gray-500">
                ...
                <span className="leading-relaxed">
                  ...
                  <a href="/authors/ustaad-subject-specialists" className="text-[#0f4a9b] font-semibold underline">{BLOG.authorFull}</a>
                </span>
              </div>
              <div className="flex items-start gap-2 text-xs text-gray-500">
                <User className="h-3.5 w-3.5 text-[#C7A24A] shrink-0 mt-0.5" />
