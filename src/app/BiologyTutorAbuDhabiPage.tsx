    ...
    >
      ...
      <style>{`
        .biology-ask-expert-section {
          --colour-biology-bg: #f8f9fb;
          --colour-biology-teal: #0f4a9b;
          --colour-biology-dark: #0a1f3d;
          --colour-biology-muted: #6b7c93;
          --colour-biology-white: #ffffff;
          --colour-biology-border: #e2e6ec;
          --colour-whatsapp-green: #25D366;
          --colour-whatsapp-green-hover: #128C7E;
          --radius-button: 8px;
          --radius-card: 16px;
          --radius-bubble: 12px;
          --shadow-biology-card: 0 4px 20px rgba(0,0,0,0.05);
    ...
    <Layout>
      ...
      <section className="relative -mt-16 overflow-hidden bg-[#0a1f3d] flex flex-col items-center justify-center md:min-h-[75vh]">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none z-0 hidden md:block">
          <svg viewBox="0 0 1400 600" preserveAspectRatio="xMidYMid slice"
            ...
            {(()=>{
              ...
              for (let i=0; i<=80; i++) { 
                const wx=-Math.PI+(i/80)*2*Math.PI, base=gp(w2c(wx),ROWS); 
                const y1 = base.y - 120 - Math.sin(wx*3)*60;
                const y2 = base.y - 120 - Math.sin(wx*3 + Math.PI)*60;
                dna1.push(`${base.x},${y1}`);
                dna2.push(`${base.x},${y2}`);
                if (i % 4 === 0) rungs.push(<line key={`r${i}`} x1={base.x} y1={y1} x2={base.x} y2={y2} stroke="rgba(95,211,230,0.2)" strokeWidth="1.5" />);
              }
              out.push(...rungs);
              out.push(<polyline key="d1" points={dna1.join(' ')} fill="none" stroke="url(#sinGrad)" strokeWidth="2.8" filter="url(#softglow)"/>);
              out.push(<polyline key="d2" points={dna2.join(' ')} fill="none" stroke="url(#parGrad)" strokeWidth="2.8" filter="url(#softglow)"/>);
              
              const pulseLblB=gp(w2c(-2.0),ROWS), cellLblB=gp(w2c(2.3),ROWS);
              out.push(<text key="slbl" x={pulseLblB.x-24} y={pulseLblB.y-220} fill="rgba(95,211,230,0.72)" fontSize="14" fontFamily="monospace">DNA</text>);
              out.push(<text key="plbl" x={cellLblB.x+4} y={cellLblB.y-230} fill="rgba(240,201,106,0.72)" fontSize="14" fontFamily="monospace">RNA</text>);
              return out;
            })()}
          </svg>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[170px] sm:h-[190px] pointer-events-none z-0 md:hidden">
          <svg viewBox="300 100 800 250" preserveAspectRatio="xMidYMid slice"
            ...
            {(()=>{
              ...
              out.push(...rungs);
              out.push(<polyline key="d1" points={dna1.join(' ')} fill="none" stroke="url(#m-sinGrad)" strokeWidth="2.8" filter="url(#m-softglow)"/>);
              out.push(<polyline key="d2" points={dna2.join(' ')} fill="none" stroke="url(#m-parGrad)" strokeWidth="2.8" filter="url(#m-softglow)"/>);
        ...
        >
          ...
          <motion.p
            ...
            className="text-blue-100/70 text-[15px] sm:text-[17px] max-w-2xl leading-relaxed mb-8 md:mb-10 font-medium"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {challenges.map((c, idx) => (
              <motion.div
                ...
                className="bg-white p-6 rounded-xl border border-[#e2e6ec] shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex flex-col justify-between transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-[#0f4a9b]/30"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {topics.map((t, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.4, delay: idx * 0.08 }}
                className="bg-[#f8f9fb] p-6 rounded-xl border border-[#e2e6ec] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-[#0f4a9b]/30"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {medicinePathway.map((item, idx) => (
              <div key={idx} className="bg-white p-6 rounded-xl border border-[#e2e6ec] shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-[#0f4a9b]/30" style={{ minHeight: '130px' }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="p-6 rounded-xl border border-white/10 shadow-lg flex flex-col justify-between transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_8px_30px_rgba(255,255,255,0.12)] hover:border-white/30" style={{ minHeight: '190px', background: 'rgba(255,255,255,0.06)', borderColor: 'rgba(110,168,255,0.18)' }}>
                <div>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {boardRows.map((b, idx) => (
              <div key={idx} className="bg-[#f8f9fb] p-6 rounded-xl border border-[#e2e6ec] flex flex-col justify-between transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-[#0f4a9b]/30" style={{ minHeight: '180px' }}>
                <div>
      ...
      <section className="py-12 sm:py-16 bg-[#f8f9fb]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Reem Grade */}
            <div className="bg-white p-6 rounded-xl border border-[#e2e6ec] shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex flex-col justify-between transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-[#0f4a9b]/30">
              <div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl p-8 sm:p-10 text-center" style={{ background: 'linear-gradient(135deg, #0a1f3d 0%, #071833 100%)' }}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              <a href="https://wa.me/971561249005" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-3.5 rounded-lg text-sm font-bold text-white bg-[#25D366] hover:bg-[#128C7E] transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-4">
            <a
              ...
              className="group block rounded-2xl p-5 sm:p-6 transition-all bg-white border border-[#e2e6ec] shadow-[0_2px_8px_rgba(0,0,0,0.02)] hover:-translate-y-1.5 hover:shadow-xl hover:border-[#0f4a9b]/30"
            >
