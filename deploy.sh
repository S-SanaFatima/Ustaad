...
echo "  Build branch  : deploy-latest (backup only)"
echo ""
echo "  Live site: GitHub Action 'Deploy to cPanel via FTP' runs after push to main."
echo "  Check: https://github.com/S-SanaFatima/Ustaad/actions"
echo "  No cPanel Terminal or Git Pull needed."
